...
bool MS5611::begin(ms5611_osr_t osr)
{
    ...
    referenceTemperature = readRawTemperature();
...
int32_t MS5611::readPressureAtConstantTemperature(bool compensation)
{
    uint32_t D1 = readRawPressure();

    int32_t dT = referenceTemperature - (uint32_t)fc[4] * 256;
